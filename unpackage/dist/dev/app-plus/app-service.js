...
详细信息：${s4}`), r3(i3);
    ...
    methods: {
      getUserList() {
        ...
        uni.getSystemInfo({
          ...
          fail: function(err) {
            formatAppLog("log", "at pages/setting/setting.vue:48", err);
          }
        });
        formatAppLog("log", "at pages/setting/setting.vue:51", "本机设备ID：" + this.deviceId);
        Ds.callFunction({
          name: "readUserInfo",
          data: {
            deviceId: this.deviceId
          ...
          formatAppLog("log", "at pages/setting/setting.vue:63", err);
        });
      }
    }
  };
    ...
    methods: {
      ...
      getUserInfo() {
        ...
        uni.getSystemInfo({
          ...
          fail: function(err) {
            formatAppLog("log", "at pages/setting/register/register.vue:35", err);
          }
        });
        formatAppLog("log", "at pages/setting/register/register.vue:38", "用户昵称：" + this.userName);
        formatAppLog("log", "at pages/setting/register/register.vue:39", "手机号：" + this.passWord);
        formatAppLog("log", "at pages/setting/register/register.vue:40", "设备ID：" + that.deviceId);
      ...
      vue.createElementVNode("view", { class: "inputWrapper" }, [
        vue.createElementVNode(
          "input",
          {
            class: "input",
            type: "text",
            onInput: _cache[0] || (_cache[0] = (...args) => $options.inputUserName && $options.inputUserName(...args)),
            value: "",
            placeholder: "请输入用户名"
          },
          null,
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "D:/Coding/Bill/App.vue"]]);
  function createApp() {
